...
import com.fagawee.mvp.kit.Kits;
import com.fagawee.mvp.imageloader.ILoader;
import com.fagawee.mvp.router.Router;

/**
 * Created by Mr.Tian on 2016/12/4.
 */

public class XFagaweeConf {
    // #log
    public static boolean LOG = true;
    public static String LOG_TAG = "TLOG";
